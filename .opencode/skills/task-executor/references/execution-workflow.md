...
Reference workflow for the task-executor skill. This document describes the end-to-end task execution process.
...
**Log schemas:** See `schemas.md` for detailed JSON schemas
...
- `schemas.md` - JSON schemas for all log and knowledge files
- `skill-orchestration.md` - Detailed skill decision logic
