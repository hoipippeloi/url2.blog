...
#### Important: When adding logic, writing code, implementing features, always use the Test Driven Development (TDD) approach with the skill found in .opencode\skills\tdd-workflow\SKILL.md

## OpenMemory Integration - for memory database building and retrieval
**File**: `openmemory.md`
...
- Sveltekit / Svelte 5: .opencode\skills\svelte5-best-practices\SKILL.md
- Typescript: .opencode\skills\mastering-typescript\SKILL.md
- Tailwind CSS: .opencode\skills\sveltekit-svelte5-tailwind-skill\SKILL.md

## Tools you can use

- When you need to analyze codebase, complexities or dependencies, use: .opencode\skills\codebase-context\SKILL.md to get a graph of the codebase
- Agent-browser: .opencode\skills\agent-browser\SKILL.md
- Railway for deployment: .opencode\skills\railway-docs\SKILL.md, always first ask to use this when relevant

## CRITICAL REMINDERS

1. **Always use the Test Driven Development (TDD) approach** with the skill found in .opencode\skills\tdd-workflow\SKILL.md when adding logic, writing code, implementing features.


## My Preferences

- For frontend development, use .opencode\skills\modern-frontend-design\SKILL.md
- Never start a dev server i'll do that myself if you need one just ask.
- I am using windows 11 pro
- When you dont understand something, ask for clarification before proceeding.

# Development behavior you need to adopt
